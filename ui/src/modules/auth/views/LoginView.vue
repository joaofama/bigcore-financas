<template>
  <div class="min-h-screen bg-black flex flex-col items-center justify-center px-4 font-sans">
    
    <div class="text-center mb-8 max-w-xl">
      <h1 class="text-white text-4xl font-bold mb-4">Controle Financeiro Pessoal</h1>
      <p class="text-gray-400 text-sm leading-relaxed">
        Para onde está indo meu dinheiro? Para administrar bem suas finanças, você precisa
        saber quanto dinheiro ganha (receitas) e para onde ele vai (despesas).
      </p>
    </div>

    <div class="bg-[#121212] p-10 rounded-2xl border border-gray-800 w-full max-w-[440px] shadow-2xl">
      <h2 class="text-white text-3xl font-semibold text-center mb-10">Login</h2>

      <form @submit.prevent="handleLogin" class="space-y-6">
        <div>
          <label class="block text-gray-400 text-xs font-bold uppercase mb-2 tracking-wider">Email</label>
          <input 
            v-model="form.email"
            type="email" 
        ...
        <div>
          <label class="block text-gray-400 text-xs font-bold uppercase mb-2 tracking-wider">Senha</label>
          <input 
